...
func (me implWorkspace) FindFiles(include GlobPattern, exclude *GlobPattern, maxResults *int, token *Cancel, andThen func([]string)) {
	var msg *ipcMsg
	msg = new(ipcMsg)
...
func (me implWorkspace) Properties(andThen func(WorkspaceProperties)) {
	var msg *ipcMsg
	msg = new(ipcMsg)
