...
type Window interface {
	...
	ShowInputBox(options *InputBoxOptions, token *CancellationToken, andThen func(*string)) 
}
...
func (me *impl) ShowInputBox(options *InputBoxOptions, token *CancellationToken, andThen func(*string)) {
	var msg *ipcMsg
	msg = new(ipcMsg)
