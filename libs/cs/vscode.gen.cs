...
namespace VscAppz {
	...
	public interface IWorkspace {
		...
		/// <return>A thenable that resolves to an array of resource identifiers. Will return no results if no [workspace folders](#workspace.workspaceFolders) are opened.</return>
