...
* [QuickPick_OnDidTriggerButton](#quickpick_ondidtriggerbutton)
...
###  QuickPick_OnDidTriggerButton

▸ **QuickPick_OnDidTriggerButton**(`this`: [QuickPick](#interfaces_vscode_gen_quickpickmd), `handler`: function): *function*
...
▸ (`_`: [QuickInputButton](#interfaces_vscode_gen_quickinputbuttonmd), `__`: [QuickPickState](#interfaces_vscode_gen_quickpickstatemd)): *void*
