...
- `Left` &mdash; Aligned to the left side.

- `Right` &mdash; Aligned to the right side.

## DecorationRangeBehavior `enum`

Describes the behavior of decorations when typing/editing at their edges.

- `OpenOpen` &mdash; The decoration's range will widen when edits occur at the start or end.

- `ClosedClosed` &mdash; The decoration's range will not widen when edits occur at the start of end.

- `OpenClosed` &mdash; The decoration's range will widen when edits occur at the start, but not at the end.

- `ClosedOpen` &mdash; The decoration's range will widen when edits occur at the end, but not at the start.
...
### Window.ShowInformationMessage1(message, items)

Show an information message to users. Optionally provide an array of items which will be presented as
clickable buttons.

- `message` &mdash; The message to show.

- `items` &mdash; A set of items that will be rendered as actions in the message.

- `return` &mdash; A thenable that resolves to the selected item or `undefined` when being dismissed.

### Window.ShowInformationMessage2(message, options, items)
...
- `options` &mdash; Configures the behaviour of the message.

- `items` &mdash; A set of items that will be rendered as actions in the message.

- `return` &mdash; A thenable that resolves to the selected item or `undefined` when being dismissed.

### Window.ShowInformationMessage3(message, items)
...
### Window.ShowInformationMessage4(message, options, items)
...
### Window.ShowWarningMessage1(message, items)
...
### Window.ShowWarningMessage2(message, options, items)
...
### Window.ShowWarningMessage3(message, items)
...
### Window.ShowWarningMessage4(message, options, items)
...
### Window.ShowErrorMessage1(message, items)
...
### Window.ShowErrorMessage2(message, options, items)
...
### Window.ShowErrorMessage3(message, items)
...
### Window.ShowErrorMessage4(message, options, items)
...
### Window.ShowInputBox(options, token)
...
- `options` &mdash; Configures the behavior of the input box.

- `token` &mdash; A token that can be used to signal cancellation.

- `return` &mdash; A promise that resolves to a string the user provided or to `undefined` in case of dismissal.

### Window.ShowQuickPick1(items, options, token)

Shows a selection list allowing multiple selections.

- `items` &mdash; An array of strings, or a promise that resolves to an array of strings.

- `options` &mdash; Configures the behavior of the selection list.

- `token` &mdash; A token that can be used to signal cancellation.

- `return` &mdash; A promise that resolves to the selected items or `undefined`.

### Window.ShowQuickPick2(items, options, token)
...
- `return` &mdash; A promise that resolves to the selection or `undefined`.

### Window.ShowQuickPick3(items, options, token)

Shows a selection list allowing multiple selections.

- `items` &mdash; An array of items, or a promise that resolves to an array of items.
...
### Window.ShowQuickPick4(items, options, token)
...
- `return` &mdash; A promise that resolves to the selected item or `undefined`.

### Window.SetStatusBarMessage1(text, hideAfterTimeout)

Set a message to the status bar. This is a short hand for the more powerful
status bar [items](https://code.visualstudio.com/api/references/vscode-api#window.createStatusBarItem).

- `text` &mdash; The message to show, supports icon substitution as in status bar [items](https://code.visualstudio.com/api/references/vscode-api#StatusBarItem.text).

- `hideAfterTimeout` &mdash; Timeout in milliseconds after which the message will be disposed.

- `return` &mdash; A disposable which hides the status bar message.
...
- `options` &mdash; Options that control the dialog.

- `return` &mdash; A promise that resolves to the selected resource or `undefined`.
...
- `return` &mdash; A promise that resolves to the selected resources or `undefined`.
...
- `options` &mdash; Configures the behavior of the workspace folder list.

- `return` &mdash; A promise that resolves to the workspace folder or `undefined`.
...
- `alignment` &mdash; The alignment of the item.

- `priority` &mdash; The priority of the item. Higher values mean the item should be shown more to the left.

- `return` &mdash; A new status bar item.
...
- `name` &mdash; Human-readable string which will be used to represent the channel in the UI.

### Window.CreateTextEditorDecorationType(options)

Create a TextEditorDecorationType that can be used to add decorations to text editors.

- `options` &mdash; Rendering options for the decoration type.

- `return` &mdash; A new decoration type instance.
...
- `target` &mdash; The uri that should be opened.

- `return` &mdash; A promise indicating if open was successful.
...
- `return` &mdash; A thenable that resolves to a string.

### Clipboard.WriteText(value)

Writes text into the clipboard.

- `return` &mdash; A thenable that resolves when writing happened.
...
- `includeUntitled` &mdash; Also save files that have been created during this session.

- `return` &mdash; A thenable that resolves when the files have been saved.
...
- `return` &mdash; A workspace folder or `undefined`
...
- `include` &mdash; A [glob pattern](https://code.visualstudio.com/api/references/vscode-api#GlobPattern) that defines the files to search for. The glob pattern
...
- `exclude` &mdash; A [glob pattern](https://code.visualstudio.com/api/references/vscode-api#GlobPattern) that defines files and folders to exclude. The glob pattern
will be matched against the file paths of resulting matches relative to their workspace. When `undefined` only default excludes will
apply, when `null` no excludes will apply.

- `maxResults` &mdash; An upper-bound for the result.

- `token` &mdash; A token that can be used to signal cancellation to the underlying search engine.

- `return` &mdash; A thenable that resolves to an array of resource identifiers. Will return no results if no
[workspace folders](https://code.visualstudio.com/api/references/vscode-api#workspace.workspaceFolders) are opened.

### Workspace.AsRelativePath(pathOrUri, includeWorkspaceFolder)
...
- `pathOrUri` &mdash; A path or uri. When a uri is given its [fsPath](https://code.visualstudio.com/api/references/vscode-api#Uri.fsPath) is used.

- `includeWorkspaceFolder` &mdash; When `true` and when the given path is contained inside a
workspace folder the name of the workspace is prepended. Defaults to `true` when there are
multiple workspace folders and `false` otherwise.

- `return` &mdash; A path relative to the root or the input.
...
- `return` &mdash; Promise resolving to an array of identifier strings.
...
- `command` &mdash; A unique identifier for the command.

- `callback` &mdash; A command handler function.

- `return` &mdash; Disposable which unregisters this command on disposal.
...
- `command` &mdash; Identifier of the command to execute.

- `rest` &mdash; Parameters passed to the command function.

- `return` &mdash; A thenable that resolves to the returned value of the given command. `undefined` when
...
- `filterInternal` &mdash; Set `true` to not see internal commands (starting with an underscore)

- `return` &mdash; Thenable that resolves to a list of command ids.
...
### InputBoxOptions.`valueSelection`
...
### InputBoxOptions.`password`

Set to `true` to show a password prompt that will not show the typed value.

### InputBoxOptions.`ignoreFocusOut`

Set to `true` to keep the input box open when focus moves to another part of the editor or to another window.

### InputBoxOptions.`validateInput`
...
### SaveDialogOptions.`defaultUri`

The resource the dialog shows when opened.

### SaveDialogOptions.`saveLabel`
...
### OpenDialogOptions.`defaultUri`

The resource the dialog shows when opened.

### OpenDialogOptions.`openLabel`
...
### OpenDialogOptions.`canSelectFolders`

Allow to select folders, defaults to `false`.

### OpenDialogOptions.`canSelectMany`
...
### WorkspaceFolderPickOptions.`placeHolder`

An optional string to show as place holder in the input box to guide the user what to pick on.

### WorkspaceFolderPickOptions.`ignoreFocusOut`
...
### DecorationRenderOptions.`isWholeLine`

Should the decoration be rendered also on the whitespace after the line text.
Defaults to `false`.

### DecorationRenderOptions.`rangeBehavior`

Customize the growing behavior of the decoration when edits occur at the edges of the decoration's range.
Defaults to `DecorationRangeBehavior.OpenOpen`.

### DecorationRenderOptions.`overviewRulerLane`

The position in the overview ruler where the decoration should be rendered.

### DecorationRenderOptions.`light`

Overwrite options for light themes.

### DecorationRenderOptions.`dark`
...
### ThemableDecorationRenderOptions.`backgroundColor`
...
### ThemableDecorationRenderOptions.`outline`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`outlineColor`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'outline' for setting one or more of the individual outline properties.

### ThemableDecorationRenderOptions.`outlineStyle`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'outline' for setting one or more of the individual outline properties.

### ThemableDecorationRenderOptions.`outlineWidth`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'outline' for setting one or more of the individual outline properties.

### ThemableDecorationRenderOptions.`border`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`borderColor`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'border' for setting one or more of the individual border properties.

### ThemableDecorationRenderOptions.`borderRadius`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'border' for setting one or more of the individual border properties.

### ThemableDecorationRenderOptions.`borderSpacing`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'border' for setting one or more of the individual border properties.

### ThemableDecorationRenderOptions.`borderStyle`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'border' for setting one or more of the individual border properties.

### ThemableDecorationRenderOptions.`borderWidth`

CSS styling property that will be applied to text enclosed by a decoration.
Better use 'border' for setting one or more of the individual border properties.

### ThemableDecorationRenderOptions.`fontStyle`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`fontWeight`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`textDecoration`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`cursor`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`color`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`opacity`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationRenderOptions.`letterSpacing`
...
### ThemableDecorationRenderOptions.`gutterIconSize`

Specifies the size of the gutter icon.
Available values are 'auto', 'contain', 'cover' and any percentage value.
For further information: https://msdn.microsoft.com/en-us/library/jj127316(v=vs.85).aspx

### ThemableDecorationRenderOptions.`overviewRulerColor`

The color of the decoration in the overview ruler. Use rgba() and define transparent colors to play well with other decorations.

### ThemableDecorationRenderOptions.`before`

Defines the rendering options of the attachment that is inserted before the decorated text.

### ThemableDecorationRenderOptions.`after`
...
### ThemableDecorationAttachmentRenderOptions.`contentText`

Defines a text content that is shown in the attachment. Either an icon or a text can be shown, but not both.

### ThemableDecorationAttachmentRenderOptions.`contentIconPath`

An **absolute path** or an URI to an image to be rendered in the attachment. Either an icon
or a text can be shown, but not both.

### ThemableDecorationAttachmentRenderOptions.`border`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`borderColor`

CSS styling property that will be applied to text enclosed by a decoration.

### ThemableDecorationAttachmentRenderOptions.`fontStyle`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`fontWeight`
...
### ThemableDecorationAttachmentRenderOptions.`color`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`backgroundColor`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`margin`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`width`

CSS styling property that will be applied to the decoration attachment.

### ThemableDecorationAttachmentRenderOptions.`height`
...
### WorkspaceFoldersChangeEvent.`removed`
...
### EnvProperties.`appRoot`

The application root folder from which the editor is running.

### EnvProperties.`language`

Represents the preferred user-language, like `de-CH`, `fr`, or `en-US`.

### EnvProperties.`machineId`

A unique identifier for the computer.

### EnvProperties.`remoteName`
...
### WorkspaceProperties.`workspaceFile`
...
### WorkspaceProperties.`workspaceFolders`
...
### StatusBarItemProperties.`Alignment`

The alignment of this item.

### StatusBarItemProperties.`Priority`

The priority of this item. Higher value means the item should
be shown more to the left.

### StatusBarItemProperties.`text`
...
### StatusBarItemProperties.`tooltip`

The tooltip text when you hover over this entry.

### StatusBarItemProperties.`color`

The foreground color for this entry.

### StatusBarItemProperties.`command`
...
### TextEditorDecorationTypeProperties.`Key`
...
------ | ------ | ------ |
`msFromNow` | number | An array of strings, or a promise that resolves to an array of strings.  |
...
Name | Type | Description |
------ | ------ | ------ |
`_this` | [Vscode](#interfaces_vscode_gen_vscodemd) | An array of strings, or a promise that resolves to an array of strings. |
`err` | any | Configures the behavior of the selection list. |
`jsonMsg?` | any | A token that can be used to signal cancellation.  |
