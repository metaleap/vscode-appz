            ...
            on = (payload: any): boolean {
                ...
                if ((undefined !== payload && null !== payload)) {
                    ...
                    for (const __item__result of __coll__result) {
                        ...
                        [__val__result,ok] = __item__result
                        if ((!ok)) {
                            return false
                        }
                        ...
                        Commands·GetCommands: (filterInternal:boolean -> then:(_: string[]) => void -> void)
{
                    ...
                    class implMessageItem extends implBase implements MessageItem {
                        constructor(impl: impl) { super(impl) }
                        ...
                        MessageItem·populateFrom: (payload:any -> boolean)
{
                        ...
                        class implQuickPickItem extends implBase implements QuickPickItem {
                            constructor(impl: impl) { super(impl) }
                            ...
                            QuickPickItem·populateFrom: (payload:any -> boolean)
{
                            ...
                            class implWorkspaceFolder extends implBase implements WorkspaceFolder {
                                constructor(impl: impl) { super(impl) }
                                ...
                                WorkspaceFolder·populateFrom: (payload:any -> boolean)
{
                                ...
                                class implWindowState extends implBase implements WindowState {
                                    constructor(impl: impl) { super(impl) }
                                    ...
                                    WindowState·populateFrom: (payload:any -> boolean)
{
                                    ...
                                    class implEnvProperties extends implBase implements EnvProperties {
                                        constructor(impl: impl) { super(impl) }
                                        ...
                                        EnvProperties·populateFrom: (payload:any -> boolean)
{
                                        ...
                                        class implWorkspaceFoldersChangeEvent extends implBase implements WorkspaceFoldersChangeEvent {
                                            constructor(impl: impl) { super(impl) }
                                            ...
                                            WorkspaceFoldersChangeEvent·populateFrom: (payload:any -> boolean)
{
                                            ...
                                            class implWorkspaceProperties extends implBase implements WorkspaceProperties {
                                                constructor(impl: impl) { super(impl) }
                                                ...
                                                WorkspaceProperties·populateFrom: (payload:any -> boolean)
{
                                                    ...
                                                    if (ok) {
                                                        ...
                                                        if ((undefined !== val && null !== val)) {
                                                            ...
                                                            [__coll__workspaceFolders,ok] = val
                                                            if ((!ok)) {
                                                                return false
                                                            }
                                                            workspaceFolders = []
                                                ...
                                                class implDiagnosticChangeEvent extends implBase implements DiagnosticChangeEvent {
                                                    constructor(impl: impl) { super(impl) }
