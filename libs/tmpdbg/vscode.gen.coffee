...
Env·Properties: (then:(EnvProperties->void) -> void)
    var msg of ?ipcMsg
    msg = ?ipcMsg·new
...
Workspace·Properties: (then:(WorkspaceProperties->void) -> void)
    var msg of ?ipcMsg
    msg = ?ipcMsg·new
