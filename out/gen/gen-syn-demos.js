    ...
    constructor(gen, b, ...names) {
        ...
        this.all = {
            ...
            "demo_Window_CreateQuickPick": () => [
                _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateQuickPick"))), _.eFunc([{ Name: "ctl", Type: { Name: "QuickPick" }, }, { Name: "cfg", Type: { Name: "QuickPickBag" } }], null, _.iSet(_._("cfg", "IgnoreFocusOut"), _.eLit(true)), _.iSet(_._("cfg", "Title"), _.eLit("I'm a full-fledged QuickPick")), _.iSet(_._("cfg", "Step"), _.eLit(23)), _.iSet(_._("cfg", "TotalSteps"), _.eLit(42)), _.iSet(_._("cfg", "Items"), _.eCollNew(_.eLit(88), { Name: "QuickPickItem" }, true)), _.iFor(_.n("i"), _.eCall(_._("nums1To"), _.eLit(88)), _.iSet(_.oIdx(_._("cfg", "Items"), _.n("i")), _.eNew({ Name: "QuickPickItem" })), _.iSet(_._(_.oIdx(_._("cfg", "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Label"), _.eLit("$(eye) Label {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("cfg", "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Description"), _.eLit("$(gift) Description {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("cfg", "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Detail"), _.eLit("$(globe~spin) Detail {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("cfg", "Items"), _.eOp("-", _._("i"), _.eLit(1))), "AlwaysShow"), _.oEq(_._("i"), _.eLit(42)))), _.eCall(_._("ctl", "Set"), _._("cfg")), _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([{ Name: "bag", Type: { Name: "QuickPickBag" } }], null, _.eCall(_._("logLn"), _.eLit("Picked: {0}", _._("bag", "SelectedItems"))), _.eCall(_._("ctl", "Hide")))), _.eCall(_._("ctl", "OnDidHide"), _.eFunc([{ Name: "_", Type: { Name: "QuickPickBag" } }], null, _.eCall(_._("ctl", "Dispose")))), _.eCall(_._("ctl", "Show")))),
            ],
            "demo_Window_CreateInputBox": () => [
                _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateInputBox"))), _.eFunc([{ Name: "ctl", Type: { Name: "InputBox" } }, { Name: "cfg", Type: { Name: "InputBoxBag" } }], null, _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("IgnoreFocusOut"))), _.eLit(true)), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Placeholder"))), _.eLit("The initial Placeholder")), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Prompt"))), _.eLit("The initial Prompt")), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Title"))), _.eLit("The initial Title")), _.eCall(_.oDot(_.n("ctl"), _.n("Set")), _.n("cfg")), _.eCall(_.oDot(_.n("ctl"), _.n("OnDidChangeValue")), _.eFunc([{ Name: "input", Type: gen_syn_1.TypeRefPrim.String }, { Name: "bag", Type: { Name: "InputBoxBag" } }], null, _.iSet(_.oDot(_.n("bag"), _.n(this.fld("Prompt"))), _.eLit("Lower: {0}", _.eCall(_.n("strLo"), _.oDot(_.n("bag"), _.n(this.fld("Value")))))), _.iSet(_.oDot(_.n("bag"), _.n(this.fld("Title"))), _.eLit("Upper: {0}", _.eCall(_.n("strUp"), _.oDot(_.n("bag"), _.n(this.fld("Value")))))), _.eCall(_.oDot(_.n("ctl"), _.n("Set")), _.n("bag")))), _.iVar("finalinputvalue", { Maybe: gen_syn_1.TypeRefPrim.String }), _.eCall(_.oDot(_.n("ctl"), _.n("OnDidAccept")), _.eFunc([{ Name: "bag", Type: { Name: "InputBoxBag" } }], null, _.iSet(_.n("finalinputvalue"), _.oAddr(_.oDot(_.n("bag"), _.n(this.fld("Value"))))), _.eCall(_.oDot(_.n("ctl"), _.n("Hide"))))), _.eCall(_.oDot(_.n("ctl"), _.n("OnDidHide")), _.eFunc([{ Name: "bag", Type: { Name: "InputBoxBag" } }], null, _.eCall(_.oDot(_.n("ctl"), _.n("Dispose"))), _.iIf(_.oIs(_.n("finalinputvalue")), [
                    this.genInfoMsg(_, _.eLit("You entered: `{0}`, ponderous!", _.oDeref(_.n("finalinputvalue")))),
                ], [
                    this.genByeMsg(_, "Backing off or backing up?"),
                ]))), _.eCall(_.oDot(_.n("ctl"), _.n("Show"))))),
            ],
        ...
        this.all["onUpAndRunning"] = () => ([
            ...
            ]), _.eCall(_.eCall(_.oDot(_.n("statusitem"), _.n("Set")), _.n("props")), _.n("demosMenu")))), _.iRet(_.eZilch()))), _.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Commands"))), _.n("RegisterCommand")), _.n("cmdName"), _.n("mycmd")), _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateStatusBarItem")), _.eLit(0), _.eZilch()), _.eFunc([{ Name: "it", Type: { Name: "StatusBarItem" } }, { Name: "cfg", Type: { Name: "StatusBarItemBag" } }], null, _.iSet(_.n("statusitem"), _.n("it")), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Tooltip"))), _.eLit("Hi from {0}!", _.n("appName"))), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Text"))), _.eLit("You clicked me 0 time(s).")), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Color"))), _.eLit("#42BEEF")), _.iSet(_.oDot(_.n("cfg"), _.n(this.fld("Command"))), _.n("cmdName")), _.eCall(_.oDot(_.n("statusitem"), _.n("Set")), _._("cfg")), _.eCall(_.oDot(_.n("statusitem"), _.n("Show")))))),
        ]);
    }
    genDemos() {
        this.gen.emitIntro();
