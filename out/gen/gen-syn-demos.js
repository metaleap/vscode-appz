    ...
    constructor(gen, b, ...names) {
        ...
        this.all = {
            ...
            "demo_Window_CreateQuickPick": () => [
                ...
                _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateQuickPick")), _.oAddr(_._("cfg"))), _.eFunc([{ Name: "ctl", Type: { Name: "QuickPick" }, }, { Name: "_unused", Type: { Name: "QuickPickState" } }], null, _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([{ Name: "props", Type: { Name: "QuickPickState" } }], null, _.eCall(_._("logLn"), _.eLit("Picked: {0}", _._("props", "SelectedItems"))), _.eCall(_._("ctl", "Hide")))), _.eCall(_._("ctl", "OnDidHide"), _.eFunc([{ Name: "_", Type: { Name: "QuickPickState" } }], null, _.eCall(_._("ctl", "Dispose")))), _.eCall(_._("ctl", "Show")))),
            ],
            "demo_Window_CreateInputBox": () => [
                _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateInputBox")), _.eZilch()), _.eFunc([{ Name: "inputbox", Type: { Name: "InputBox" } }, { Name: "props", Type: { Name: "InputBoxState" } }], null, _.iSet(_.oDot(_.n("props"), _.n(this.fld("IgnoreFocusOut"))), _.eLit(true)), _.iSet(_.oDot(_.n("props"), _.n(this.fld("Placeholder"))), _.eLit("The initial Placeholder")), _.iSet(_.oDot(_.n("props"), _.n(this.fld("Prompt"))), _.eLit("The initial Prompt")), _.iSet(_.oDot(_.n("props"), _.n(this.fld("Title"))), _.eLit("The initial Title")), _.eCall(_.oDot(_.n("inputbox"), _.n("Set")), _.n("props")), _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidChangeValue")), _.eFunc([{ Name: "input", Type: gen_syn_1.TypeRefPrim.String }, { Name: "ctl", Type: { Name: "InputBoxState" } }], null, _.iSet(_.oDot(_.n("ctl"), _.n(this.fld("Prompt"))), _.eLit("Lower: {0}", _.eCall(_.n("strLo"), _.oDot(_.n("ctl"), _.n(this.fld("Value")))))), _.iSet(_.oDot(_.n("ctl"), _.n(this.fld("Title"))), _.eLit("Upper: {0}", _.eCall(_.n("strUp"), _.oDot(_.n("ctl"), _.n(this.fld("Value")))))), _.eCall(_.oDot(_.n("inputbox"), _.n("Set")), _.n("ctl")))), _.iVar("finalinputvalue", { Maybe: gen_syn_1.TypeRefPrim.String }), _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidAccept")), _.eFunc([{ Name: "ctl", Type: { Name: "InputBoxState" } }], null, _.iSet(_.n("finalinputvalue"), _.oAddr(_.oDot(_.n("ctl"), _.n(this.fld("Value"))))), _.eCall(_.oDot(_.n("inputbox"), _.n("Hide"))))), _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidHide")), _.eFunc([{ Name: "ctl", Type: { Name: "InputBoxState" } }], null, _.eCall(_.oDot(_.n("inputbox"), _.n("Dispose"))), _.iIf(_.oIs(_.n("finalinputvalue")), [
        ...
        this.all["onUpAndRunning"] = () => ([
            ...
            _.iBlock(_.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateOutputChannel")), _.n("appName")), _.eFunc([{ Name: "it", Type: { Name: "OutputChannel" } }, { Name: "_unused", Type: { Name: "OutputChannelState" } }], null, _.iSet(_.n("logchan"), _.oAddr(_.n("it"))), _.eCall(_.n("setOutChan"), _.n("logchan")), _.eCall(_.n("logLn"), _.eCall(_.n("strFmt"), _.eLit("Hi, I'm `{0}`, this is my own custom `OutputChannel` where I leisurely log all your interactions with me. When I'm ended, it too will disappear."), _.n("appName"))), _.eCall(_.n("logLn"), _.eLit("")), _.eCall(_.n("logLn"), _.eLit("NOTE that for logging error messages, you won't need to manually create a custom `OutputChannel` at all: just have your prog print to its `stderr` as (presumably) usual, and `vscode-appz` will then create a dedicated `OutputChannel` for (both that initial and all subsequent) `stderr` prints from your prog while it's up and running.")), _.eCall(_.n("logLn"), _.eLit("")), _.iIf(_.n("toggleonclick"), [
