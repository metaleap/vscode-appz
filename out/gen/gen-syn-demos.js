...
class GenDemos {
    constructor(gen, b, ...names) {
        ...
        this.all = {
            "demo_promptToExit": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowWarningMessage", 1)), _.eLit("Are you sure you want `{0}` to exit?", _.n("appName")), _.eLit(["Sure I'm sure"])), _.eFunc([{ Name: "btn", Type: { Maybe: gen_syn_1.TypeRefPrim.String } }], null, _.iIf(_.oIs(_.n("btn")), [
            ...
            "demo_clipboard": () => [
                _.eCall(_.eCall(_._(_.eCall(_._(_.eProp(_._("vsc", "Env")), "Clipboard")), "ReadText")), _.eFunc([{ Name: "text", Type: { Maybe: gen_syn_1.TypeRefPrim.String } }], null, _.iIf(_.oIsnt(_.n("text")), [
                    this.genByeMsg(_, "No text in clipboard"),
                ], this.genInput(_, "opts", "input", [{ k: "Value", v: _.oDeref(_.n("text")) }, { k: "Prompt", v: _.eLit("Enter new contents to write to your clipboard.") }], _.eCall(_.eCall(_._(_.eCall(_._(_.eProp(_._("vsc", "Env")), "Clipboard")), "WriteText"), _.oDeref(_.n("input"))), _.eFunc([], null, this.genInfoMsg(_, _.eLit("Okay. Now double-check by pasting somewhere.")))))))),
            ],
            ...
            ]), _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "ExecuteCommand"), _.oDeref(_.n("item")), _.n("cmdargs")), _.eFunc([{ Name: "ret", Type: gen_syn_1.TypeRefPrim.Any }], null, this.genInfoMsg(_, _.eLit("Command result was: `{0}`, kudos!", _.n("ret"))))))))),
            "demo_Commands_RegisterCommand": () => this.genInput(_, "opts", "cmdname", [{ k: "Value", v: _.eLit("foo.bar.baz") }, { k: "Prompt", v: _.eLit("Enter your command name. The command will accept a single text input and return a result built from it.") }], _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "RegisterCommand"), _.oDeref(_.n("cmdname")), _.eFunc([{ Name: "cmdargs", Type: { ValsOf: gen_syn_1.TypeRefPrim.Any } }], gen_syn_1.TypeRefPrim.Any, this.genStatusMsg(_, _.eLit("Command `{0}` invoked with: `{1}`", _.oDeref(_.n("cmdname")), _.oIdx(_.n("cmdargs"), _.eLit(0)))), _.iRet(_.eLit("Input to command `{0}` was: `{1}`", _.oDeref(_.n("cmdname")), _.oIdx(_.n("cmdargs"), _.eLit(0)))))), _.eFunc([{ Name: "useToUnregister", Type: { Maybe: { Name: "Disposable" } } }], null, ...this.genInput(_, "opts2", "cmdarg", [{ k: "Prompt", v: _.eLit("Command `{0}` registered, try it now?", _.oDeref(_.n("cmdname"))) }, { k: "Value", v: _.eLit("Enter input to command `{0}` here", _.oDeref(_.n("cmdname"))) }], _.iVar("cmdargs2", { ValsOf: gen_syn_1.TypeRefPrim.Any }), _.iSet(_.n("cmdargs2"), _.eCollNew(_.eLit(1), gen_syn_1.TypeRefPrim.Any, true)), _.iSet(_.oIdx(_.n("cmdargs2"), _.eLit(0)), _.oDeref(_.n("cmdarg"))), _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "ExecuteCommand"), _.oDeref(_.n("cmdname")), _.n("cmdargs2")), _.eFunc([{ Name: "ret", Type: gen_syn_1.TypeRefPrim.Any }], null, this.genInfoMsg(_, _.eLit("Command result: `{0}`, mad props!", _.n("ret"))))))))),
            ...
            "demo_Window_ShowWorkspaceFolderPick": () => [
                ...
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "ShowWorkspaceFolderPick"), _.n("opts")), _.eFunc([{ Name: "pickedfolder", Type: { Maybe: { Name: "WorkspaceFolder" } } }], null, _.iIf(_.oIsnt(_.n("pickedfolder")), [
            ...
            "demo_Window_ShowQuickPick": () => {
                ...
                ])).concat(_.iVar("opts", { Name: "QuickPickOptions" }), _.iSet(_.n("opts"), _.eNew({ Name: "QuickPickOptions" })), _.iSet(_._("opts", this.fld("IgnoreFocusOut")), _.eLit(true)), _.iSet(_._("opts", this.fld("MatchOnDescription")), _.eLit(true)), _.iSet(_._("opts", this.fld("MatchOnDetail")), _.eLit(true)), _.iSet(_._("opts", this.fld("PlaceHolder")), _.eLit("You have 42 seconds before auto-cancellation!")), _.iSet(_._("opts", this.fld("OnDidSelectItem")), _.eFunc([{ Name: "item", Type: { Name: "QuickPickItem" } }], gen_syn_1.TypeRefPrim.Any, this.genStatusMsg(_, _.eLit("Just selected: {0}", _._("item", this.fld("Label")))), _.iRet(_.eZilch()))), _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowQuickPick", 3)), _._("items"), _._("opts"), _.eCall(_.n("cancelIn"), _.eLit(42))), _.eFunc([{ Name: "pickeditems", Type: { ValsOf: { Name: "QuickPickItem" } } }], null, _.iIf(_.oIsnt(_.n("pickeditems")), [
        ...
        this.all["onUpAndRunning"] = () => ([
            ...
            _.iBlock(_.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateOutputChannel"), _.n("appName")), _.eFunc([{ Name: "it", Type: { Name: "OutputChannel" } }, { Name: "_unused", Type: { Name: "OutputChannelBag" } }], null, _.iSet(_.n("logchan"), _.oAddr(_.n("it"))), _.eCall(_._("setOutChan"), _._("logchan")), _.eCall(_.n("logLn"), _.eCall(_.n("strFmt"), _.eLit("Hi, I'm `{0}`, this is my own custom `OutputChannel` where I leisurely log all your interactions with me. When I'm ended, it too will disappear."), _._("appName"))), _.eCall(_.n("logLn"), _.eLit("")), _.eCall(_.n("logLn"), _.eLit("NOTE that for logging error messages, you won't need to manually create a custom `OutputChannel` at all: just have your prog print to its `stderr` as (presumably) usual, and `vscode-appz` will then create a dedicated `OutputChannel` for (both that initial and all subsequent) `stderr` prints from your prog while it's up and running.")), _.eCall(_.n("logLn"), _.eLit("")), _.iIf(_.n("toggleonclick"), [
            ...
            ]), _.eCall(_.eCall(_._("statusitem", "Set"), _.n("props")), _.n("demosMenu")))), _.iRet(_.eZilch()))), _.eCall(_._(_.eProp(_._("vsc", "Commands")), "RegisterCommand"), _._("cmdName"), _._("mycmd")), _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateStatusBarItem"), _.eLit(0), _.eZilch()), _.eFunc([{ Name: "it", Type: { Name: "StatusBarItem" } }, { Name: "cfg", Type: { Name: "StatusBarItemBag" } }], null, _.iSet(_._("statusitem"), _._("it")), _.iSet(_._("cfg", this.fld("Tooltip")), _.eLit("Hi from {0}!", _.n("appName"))), _.iSet(_._("cfg", this.fld("Text")), _.eLit("You clicked me 0 time(s).")), _.iSet(_._("cfg", this.fld("Color")), _.eLit("#42BEEF")), _.iSet(_._("cfg", this.fld("Command")), _.n("cmdName")), _.eCall(_._("statusitem", "Set"), _._("cfg")), _.eCall(_._("statusitem", "Show"))))),
        ]);
    }
    genDemos() {
        this.gen.emitIntro();
    ...
    genDemoOfDialog(_, which, mult, label) {
        ...
        return [
            ...
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), `Show${which}Dialog`), _.n("opts")), _.eFunc([{ Name: fp, Type: mult ? { ValsOf: gen_syn_1.TypeRefPrim.String } : { Maybe: gen_syn_1.TypeRefPrim.String } }], null, _.iIf(_.oIsnt(_.n(fp)), [
    ...
    genInput(_, nameOpts, nameInput, props, ...withInput) {
        ...
        })).concat(_.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "ShowInputBox"), _.n(nameOpts), _.eZilch()), _.eFunc([{ Name: nameInput, Type: { Maybe: gen_syn_1.TypeRefPrim.String } }], null, _.iIf(_.oIsnt(_.n(nameInput)), [
    ...
    genDemoOfPropsMenu(_, ns) {
        ...
        return [
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", ns)), "AllProperties")), _.eFunc([{ Name: "props", Type: { Name: struct.Name } }], null, _.iVar("items", { ValsOf: gen_syn_1.TypeRefPrim.String }), _.iSet(_.n("items"), _.eCollNew(_.eLit(struct.Fields.length), gen_syn_1.TypeRefPrim.String, true)), _.iBlock(..._.EACH(struct.Fields, (f, i) => [
    ...
    genDemoOfStrListMenu(_, ns, fn, desc, args, onPick) {
        return [
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", ns)), fn), ...args), _.eFunc([{ Name: "items", Type: { ValsOf: gen_syn_1.TypeRefPrim.String } }], null, ...this.genMenu(_, _.eLit("Retrieved {0} " + desc, _.eLen(_.n("items"), true)), onPick)))
        ];
    }
    genMenu(_, msg, onPick) {
        return [
            ...
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowQuickPick", 2)), _.n("items"), _.oAddr(_.n("opts")), _.eZilch()), onPick ? onPick : _.eFunc([{ Name: "menuitem", Type: { Maybe: gen_syn_1.TypeRefPrim.String } }], null, _.iIf(_.oIs(_.n("menuitem")), [_.eCall(_.n("logLn"), _.oDeref(_.n("menuitem")))])))
        ];
    }
    fn(name, overload) {
