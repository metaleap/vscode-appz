    ...
    constructor(gen, b, ...names) {
        ...
        this.all = {
            ...
            "demo_Window_CreateQuickPick": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateQuickPick")), _.eFunc([{ Name: "ctl", Type: { Maybe: { Name: "QuickPick" } }, }], null, _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("IgnoreFocusOut")), _.eLit(true)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Title")), _.eLit("I'm a full-fledged QuickPick")), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Step")), _.eLit(23)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("TotalSteps")), _.eLit(42)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eCollNew(_.eLit(88), { Name: "QuickPickItem" }, true)), _.iFor(_.eName("i"), _.eCall(_._("nums1To"), _.eLit(88)), _.iSet(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), _.eNew({ Name: "QuickPickItem" })), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Label")), _.eLit("$(eye) Label {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Description")), _.eLit("$(gift) Description {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Detail")), _.eLit("$(globe~spin) Detail {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("AlwaysShow")), _.oEq(_._("i"), _.eLit(42)))), _.eCall(_._("ctl", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)), _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([], null, _.eCall(_._("logLn"), _.eLit("Picked: {0}", _._("ctl", gen_1.idents.fldDispObjBag, this.fld("SelectedItems")))), _.eCall(_._("ctl", "Hide")))), _.eCall(_._("ctl", "OnDidHide"), _.eFunc([], null, _.eCall(_._("ctl", "Dispose")))), _.eCall(_._("ctl", "Show")))),
            ],
            "demo_Window_CreateInputBox": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateInputBox")), _.eFunc([{ Name: "ctl", Type: { Maybe: { Name: "InputBox" } } }], null, _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("IgnoreFocusOut")), _.eLit(true)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Placeholder")), _.eLit("The initial Placeholder")), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Prompt")), _.eLit("The initial Prompt")), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Title")), _.eLit("The initial Title")), _.eCall(_._("ctl", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)), _.eCall(_._("ctl", "OnDidChangeValue"), _.eFunc([{ Name: "input", Type: gen_syn_1.TypeRefPrim.String }], null, _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Prompt")), _.eLit("Lower: {0}", _.eCall(_._("strLo"), _._("ctl", gen_1.idents.fldDispObjBag, this.fld("Value"))))), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Title")), _.eLit("Upper: {0}", _.eCall(_._("strUp"), _._("ctl", gen_1.idents.fldDispObjBag, this.fld("Value"))))), _.eCall(_._("ctl", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)))), _.iVar("finalinputvalue", { Maybe: gen_syn_1.TypeRefPrim.String }), _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([], null, _.iSet(_._("finalinputvalue"), _.oAddr(_._("ctl", gen_1.idents.fldDispObjBag, this.fld("Value")))), _.eCall(_._("ctl", "Hide")))), _.eCall(_._("ctl", "OnDidHide"), _.eFunc([], null, _.eCall(_._("ctl", "Dispose")), _.iIf(_.oIs(_._("finalinputvalue")), [
            ...
            "demo_Window_CreateTerminal": () => this.genInput(_, "optsname", "termname", [
        ...
        this.all["onUpAndRunning"] = () => ([
            ...
            _.iBlock(_.iVar("statusitem", { Maybe: { Name: "StatusBarItem" } }), _.iVar("clickcount", gen_syn_1.TypeRefPrim.Int), _.iSet(_._("clickcount"), _.eLit(0)), _.iVar("mycmd", { From: [{ ValsOf: gen_syn_1.TypeRefPrim.Any }], To: gen_syn_1.TypeRefPrim.Any }), _.iSet(_._("mycmd"), _.eFunc([{ Name: "_unused", Type: { ValsOf: gen_syn_1.TypeRefPrim.Any } }], gen_syn_1.TypeRefPrim.Any, _.iSet(_._("clickcount"), _.eOp("+", _.eLit(1), _._("clickcount"))), _.eCall(_.eCall(_._("statusitem", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagFetch)), _.eFunc([], null, _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Text")), _.eCall(_._("logLn"), _.eLit("You clicked me {0} time(s).", _._("clickcount")))), _.iIf(_.oEq(_.eLit("editorLightBulb.foreground"), _._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Color"))), [
                _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Color")), _.eLit("terminal.ansiGreen")),
                _.iIf(_.oAnd(_._("toggleonclick"), _.oIs(_._("logchan"))), [_.eCall(_._("logchan", "Hide"))]),
            ], [
                _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Color")), _.eLit("editorLightBulb.foreground")),
                _.iIf(_.oAnd(_._("toggleonclick"), _.oIs(_._("logchan"))), [_.eCall(_._("logchan", "Show"), _.eLit(true))]),
            ]), _.eCall(_.eCall(_._("statusitem", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)), _._("demosMenu")))), _.iRet(_.eZilch()))), _.eCall(_._(_.eProp(_._("vsc", "Commands")), "RegisterCommand"), _._("cmdName"), _._("mycmd")), _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateStatusBarItem"), _.eLit(0), _.eZilch()), _.eFunc([{ Name: "it", Type: { Maybe: { Name: "StatusBarItem" } } }], null, _.iSet(_._("statusitem"), _._("it")), _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Tooltip")), _.eLit("Hi from {0}!", _._("appName"))), _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Text")), _.eLit("You clicked me 0 time(s).")), _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Color")), _.eLit("#42BEEF")), _.iSet(_._("statusitem", gen_1.idents.fldDispObjBag, this.fld("Command")), _._("cmdName")), _.eCall(_._("statusitem", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)), _.eCall(_._("statusitem", "Show"))))),
        ]);
    }
    genDemos() {
        this.gen.emitIntro();
