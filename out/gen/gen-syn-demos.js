    ...
    constructor(gen, b, ...names) {
        ...
        this.all = {
            ...
            "demo_Window_CreateQuickPick": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateQuickPick")), _.eFunc([{ Name: "ctl", Type: { Maybe: { Name: "QuickPick" } }, }], null, _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, "IgnoreFocusOut"), _.eLit(true)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, "Title"), _.eLit("I'm a full-fledged QuickPick")), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, "Step"), _.eLit(23)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, "TotalSteps"), _.eLit(42)), _.iSet(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _.eCollNew(_.eLit(88), { Name: "QuickPickItem" }, true)), _.iFor(_.eName("i"), _.eCall(_._("nums1To"), _.eLit(88)), _.iSet(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _._("i")), _.eNew({ Name: "QuickPickItem" })), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Label"), _.eLit("$(eye) Label {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Description"), _.eLit("$(gift) Description {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _.eOp("-", _._("i"), _.eLit(1))), "Detail"), _.eLit("$(globe~spin) Detail {0}", _._("i"))), _.iSet(_._(_.oIdx(_._("ctl", gen_1.idents.fldDispObjBag, "Items"), _.eOp("-", _._("i"), _.eLit(1))), "AlwaysShow"), _.oEq(_._("i"), _.eLit(42)))), _.eCall(_._("ctl", gen_1.idents.fldDispObjBag, gen_1.idents.methodBagPublish)), _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([], null, _.eCall(_._("logLn"), _.eLit("Picked: {0}", _._("ctl", gen_1.idents.fldDispObjBag, "SelectedItems"))), _.eCall(_._("ctl", "Hide")))), _.eCall(_._("ctl", "OnDidHide"), _.eFunc([], null, _.eCall(_._("ctl", "Dispose")))), _.eCall(_._("ctl", "Show")))),
            ],
