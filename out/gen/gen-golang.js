...
class Gen extends gen.Gen {
    ...
    genDecodeFromAny(prep, pref, srcName, dstName, dstTypeGo, nilToZeroOk, haveOk = false, onOk = undefined) {
    ...
    typeSpec(from, intoProm = false, ptrIfStruct = false, ptrIfNonNilable = false) {
        ...
        if (tsum && tsum.length) {
            ...
            tsum = tsum.filter(_ => (_ !== gen.ScriptPrimType.Null && _ !== gen.ScriptPrimType.Undefined && !gen.typeProm(_)) || !(hadnullorundef = true));
