...
class Gen extends gen.Gen {
    ...
    genMethodImpl_methodCall(ifaceOrStruct, method, _, body, idVal, impl, retIntoFld) {
        ...
        const eventlike = (arg) => {
            ...
            if (method.IsObjEvt)
                call = _.iBlock(_.iLock(_._(_.eThis(), gen.idents.fldDispObjBag), _.iSet(_._(gen.idents.varOk), _.eCall(_._(_.eThis(), gen.idents.fldDispObjBag, gen.idents.methodLoadFrom), _.oIdx(_._(gen.idents.argArgs), _.eLit(numargs))))), _.iIf(_.oNot(_._(gen.idents.varOk)), [_.iRet(_.eLit(false))]), call);
        ...
        body.push(_.iSet(_._(gen.idents.varOnResp), _.eFunc([{ Name: gen.idents.argPayload, Type: TypeRefPrim.Any }], TypeRefPrim.Bool, ..._.WHEN(dsttype, () => ((retIntoFld ? [
            _.iVar(gen.idents.varOk, TypeRefPrim.Bool),
            ...
            _.iLock(_._(_.eThis(), retIntoFld), _.iSet(_._(gen.idents.varOk), _.eCall(_._(_.eThis(), retIntoFld, gen.idents.methodLoadFrom), _._(gen.idents.argPayload)))),
            ...
            return refetch ?
                [
                    ...
                    _.iVar(gen.idents.varOk, TypeRefPrim.Bool),
                ].concat(...this.convOrRet(gen.idents.varIt, _._(gen.idents.argPayload), { ValsOf: TypeRefPrim.Any })).concat(...[
                    _.iIf(_.oOr(_.oNeq(_.eLit(2), _.eLen(_._(gen.idents.varIt), true)), _.oIsnt(_.oIdx(_._(gen.idents.varIt), _.eLit(1)))), [
                        _.iRet(_.eLit(false)),
                    ]),
                    _.iLock(_._(_.eThis(), gen.idents.fldDispObjBag), _.iSet(_._(gen.idents.varOk), _.eCall(_._(_.eThis(), gen.idents.fldDispObjBag, gen.idents.methodLoadFrom), _.oIdx(_._(gen.idents.varIt), _.eLit(1))))),
                    _.iIf(_.oNot(_._(gen.idents.varOk)), [_.iRet(_.eLit(false))]),
                    _.iIf(_.oIs(_._(gen.idents.varOnRet)), [_.eCall(_._(gen.idents.varOnRet))]),
                    _.iRet(_.eLit(true)),
                ]) : (isdispobj && method.Name === gen.idents.methodObjBagPush) ? [
                _.iVar(gen.idents.varOk, TypeRefPrim.Bool),
                _.iLock(_._(_.eThis(), gen.idents.fldDispObjBag), _.iSet(_._(gen.idents.varOk), _.eCall(_._(_.eThis(), gen.idents.fldDispObjBag, gen.idents.methodLoadFrom), _._(gen.idents.argPayload)))),
                _.iIf(_.oNot(_._(gen.idents.varOk)), [_.iRet(_.eLit(false))]),
                _.iIf(_.oIs(_._(gen.idents.varOnRet)), [_.eCall(_._(gen.idents.varOnRet))]),
                _.iRet(_.eLit(true)),
            ] : [
                ...
                if (struct.fromPrep.isPropsOfStruct) {
                    ...
                    if ((propsfields = propsfields.filter(_ => !_.readOnly)).length)
                        this.emitMethodImpl(struct, {
                            ...
                            b.push(_.iVar(gen.idents.varRet, { From: [{ From: [], To: null }], To: null }), _.iLock(_.eThis(), _.iSet(_._(gen.idents.varRet), _.eCall(_._(_.eThis(), gen.idents.fldBagHolder, gen.idents.methodObjBagPush), _.eThis()))), _.iRet(_._(gen.idents.varRet)));
                        });
                }
