                ...
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateInputBox")),
                    _.eFunc([{ Name: "ctl", Type: { Name: "InputBox" } }, { Name: "cfg", Type: { Name: "InputBoxBag" } }], null,
                        ...
                        _.eCall(_._("ctl", "OnDidChangeValue"), _.eFunc([{ Name: "input", Type: TypeRefPrim.String }, { Name: "bag", Type: { Name: "InputBoxBag" } }], null,
                            _.iSet(_._("bag", this.fld("Prompt")), _.eLit("Lower: {0}", _.eCall(_._("strLo"), _._("bag", this.fld("Value"))))),
                            _.iSet(_._("bag", this.fld("Title")), _.eLit("Upper: {0}", _.eCall(_._("strUp"), _._("bag", this.fld("Value"))))),
                            _.eCall(_._("ctl", "Set"), _._("bag")),
                        )),
        ...
        this.all["onUpAndRunning"] = () => ([
            ...
            _.iBlock(
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateOutputChannel"),
                    _._("appName")), _.eFunc([{ Name: "it", Type: { Name: "OutputChannel" } }, { Name: "_unused", Type: { Name: "OutputChannelBag" } }], null,
                        _.iSet(_._("logchan"), _.oAddr(_._("it"))),
            ...
            _.iBlock(
                ...
                _.iSet(_._("mycmd"), _.eFunc([{ Name: "_unused", Type: { ValsOf: TypeRefPrim.Any } }], TypeRefPrim.Any,
                    ...
                    _.eCall(_.eCall(_._("statusitem", "Get")), _.eFunc([{ Name: "props", Type: { Name: "StatusBarItemBag" } }], null,
                        _.iSet(_._("props", this.fld("Text")), _.eCall(_._("logLn"), _.eLit("You clicked me {0} time(s).", _._("clickcount")))),
                        ...
                        _.eCall(_.eCall(_._("statusitem", "Set"), _._("props")), _._("demosMenu")),
                    )),
                    _.iRet(_.eZilch()),
                )),
                ...
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateStatusBarItem"),
                    ...
                    _.iSet(_._("cfg", this.fld("Tooltip")), _.eLit("Hi from {0}!", _._("appName"))),
                    _.iSet(_._("cfg", this.fld("Text")), _.eLit("You clicked me 0 time(s).")),
                    _.iSet(_._("cfg", this.fld("Color")), _.eLit("#42BEEF")),
                    _.iSet(_._("cfg", this.fld("Command")), _._("cmdName")),
