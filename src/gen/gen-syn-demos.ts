...
export class GenDemos {
    ...
    constructor(gen: Gen, b: Builder, ...names: string[]) {
        ...
        this.all = {
            ...
            "demo_promptToExit": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowWarningMessage", 1)), _.eLit("Are you sure you want `{0}` to exit?", _._("appName")), _.eLit(["Sure I'm sure"])),
            ...
            "demo_clipboard": () => [
                _.eCall(_.eCall(_._(_.eCall(_._(_.eProp(_._("vsc", "Env")), "Clipboard")), "ReadText")),
                    _.eFunc([{ Name: "text", Type: { Maybe: TypeRefPrim.String } }], null,
                        _.iIf(_.oIsnt(_._("text")), [
                            this.genByeMsg(_, "No text in clipboard"),
                        ], this.genInput(
                            _, "opts", "input", [{ k: "Value", v: _.oDeref(_._("text")) }, { k: "Prompt", v: _.eLit("Enter new contents to write to your clipboard.") }],
                            _.eCall(_.eCall(_._(_.eCall(_._(_.eProp(_._("vsc", "Env")), "Clipboard")), "WriteText"), _.oDeref(_._("input"))),
                                _.eFunc([], null,
            ...
            "demo_Commands_GetCommands_and_ExecuteCommand": () =>
                this.genDemoOfStrListMenu(_, "Commands", "GetCommands", "command ID(s), pick one to execute or escape now:", [_.eLit(false)],
                    _.eFunc([{ Name: "item", Type: { ValsOf: { Name: "QuickPickItem" } } }], null,
                        _.iIf(_.oIsnt(_._("item")), [
                            this.genByeMsg(_, "Command selection cancelled, spooked?"),
                        ], this.genInput(_, "opts2", "cmdarg", [{ k: "PlaceHolder", v: _.eLit("Any param for `{0}` command? Else leave blank.", _._(_.oIdx(_._("item"), _.eLit(0)), _._(this.fld("Label")))) }],
                            _.iVar("cmdargs", { ValsOf: TypeRefPrim.Any }),
                            _.iIf(_.oNeq(_.eLit(""), _.oDeref(_._("cmdarg"))), [
                                _.iSet(_._("cmdargs"), _.eCollNew(_.eLit(1), TypeRefPrim.Any, true)),
                                _.iSet(_.oIdx(_._("cmdargs"), _.eLit(0)), _.oDeref(_._("cmdarg"))),
                            ]),
                            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "ExecuteCommand"),
                                _._(_.oIdx(_._("item"), _.eLit(0)), _._(this.fld("Label"))), _._("cmdargs"),
                            ), _.eFunc([{ Name: "ret", Type: TypeRefPrim.Any }], null,
                                this.genInfoMsg(_, _.eLit("Command result was: `{0}`, kudos!", _._("ret"))),
                            ))
                        )),
                    ),
                ),
            ...
            "demo_Commands_RegisterCommand": () =>
                this.genInput(_, "opts", "cmdname", [{ k: "Value", v: _.eLit("foo.bar.baz") }, { k: "Prompt", v: _.eLit("Enter your command name. The command will accept a single text input and return a result built from it.") }],
                    _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "RegisterCommand"),
                        _.oDeref(_._("cmdname")), _.eFunc([{ Name: "cmdargs", Type: { ValsOf: TypeRefPrim.Any } }], TypeRefPrim.Any,
                            this.genStatusMsg(_, _.eLit("Command `{0}` invoked with: `{1}`", _.oDeref(_._("cmdname")), _.oIdx(_._("cmdargs"), _.eLit(0)))),
                            _.iRet(_.eLit("Input to command `{0}` was: `{1}`", _.oDeref(_._("cmdname")), _.oIdx(_._("cmdargs"), _.eLit(0)))),
                        ),
                    ), _.eFunc([{ Name: "useToUnregister", Type: { Maybe: { Name: "Disposable" } } }], null,
                        ...this.genInput(_, "opts2", "cmdarg", [{ k: "Prompt", v: _.eLit("Command `{0}` registered, try it now?", _.oDeref(_._("cmdname"))) }, { k: "Value", v: _.eLit("Enter input to command `{0}` here", _.oDeref(_._("cmdname"))) }],
                            _.iVar("cmdargs2", { ValsOf: TypeRefPrim.Any }),
                            _.iSet(_._("cmdargs2"), _.eCollNew(_.eLit(1), TypeRefPrim.Any, true)),
                            _.iSet(_.oIdx(_._("cmdargs2"), _.eLit(0)), _.oDeref(_._("cmdarg"))),
                            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Commands")), "ExecuteCommand"),
                                _.oDeref(_._("cmdname")), _._("cmdargs2")),
                                _.eFunc([{ Name: "ret", Type: TypeRefPrim.Any }], null,
                                    this.genInfoMsg(_, _.eLit("Command result: `{0}`, mad props!", _._("ret"))),
                                ))
                        ),
                    ))
                ),
            ...
            "demo_Window_ShowWorkspaceFolderPick": () => [
                ...
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "ShowWorkspaceFolderPick"), _._("opts")),
                    _.eFunc([{ Name: "pickedfolder", Type: { Maybe: { Name: "WorkspaceFolder" } } }], null,
                        _.iIf(_.oIsnt(_._("pickedfolder")), [
            ...
            "demo_Env_OpenExternal": () => this.genInput(_, "opts", "uri", [{ k: "Value", v: _.eLit("http://github.com/metaleap/vscode-appz") }, { k: "Prompt", v: _.eLit("Enter any URI (of http: or mailto: or any other protocol scheme) to open in the applicable external app registered with your OS to handle that protocol.") }],
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Env")), "OpenExternal"), _.oDeref(_._("uri"))),
                    _.eFunc([{ Name: "ok", Type: TypeRefPrim.Bool }], null,
                        _.iVar("did", TypeRefPrim.String),
                        _.iSet(_._("did"), _.eLit("Did")),
                        _.iIf(_.oNot(_._("ok")), [
            ...
            "demo_Window_ShowQuickPick": () => {
                ...
                return ([
                    ...
                    _.iSet(_._("opts", this.fld("IgnoreFocusOut")), _.eLit(true)),
                    _.iSet(_._("opts", this.fld("CanPickMany")), _.eLit(true)),
                    ...
                    _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowQuickPick", 3)),
                        _._("items"), _._("opts"), _.eCall(_._("cancelIn"), _.eLit(42)),
                    ), _.eFunc([{ Name: "pickeditems", Type: { ValsOf: { Name: "QuickPickItem" } } }], null,
                        _.iIf(_.oIsnt(_._("pickeditems")), [
            ...
            "demo_Window_CreateQuickPick": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateQuickPick")),
                    _.eFunc([{ Name: "ctl", Type: { Maybe: { Name: "QuickPick" } }, }], null,
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("IgnoreFocusOut")), _.eLit(true)),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Title")), _.eLit("I'm a full-fledged QuickPick")),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Step")), _.eLit(23)),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("TotalSteps")), _.eLit(42)),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eCollNew(_.eLit(88), { Name: "QuickPickItem" }, true)),
                        _.iFor(_.eName("i"), _.eCall(_._("nums1To"), _.eLit(88)),
                            _.iSet(_.oIdx(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), _.eNew({ Name: "QuickPickItem" })),
                            _.iSet(_._(_.oIdx(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Label")), _.eLit("$(eye) Label {0}", _._("i"))),
                            _.iSet(_._(_.oIdx(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Description")), _.eLit("$(gift) Description {0}", _._("i"))),
                            _.iSet(_._(_.oIdx(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("Detail")), _.eLit("$(globe~spin) Detail {0}", _._("i"))),
                            _.iSet(_._(_.oIdx(_._("ctl", idents.fldDispObjBag, this.fld("Items")), _.eOp("-", _._("i"), _.eLit(1))), this.fld("AlwaysShow")), _.oEq(_._("i"), _.eLit(42))),
                        ),
                        _.eCall(_._("ctl", idents.fldDispObjBag, idents.methodBagPublish)),
                        _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([], null,
                            _.eCall(_._("logLn"), _.eLit("Picked: {0}", _._("ctl", idents.fldDispObjBag, this.fld("SelectedItems")))),
                            _.eCall(_._("ctl", "Hide")),
                        )),
                        _.eCall(_._("ctl", "OnDidHide"), _.eFunc([], null, _.eCall(_._("ctl", "Dispose")))),
            ...
            "demo_Window_CreateInputBox": () => [
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateInputBox")),
                    _.eFunc([{ Name: "ctl", Type: { Maybe: { Name: "InputBox" } } }], null,
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("IgnoreFocusOut")), _.eLit(true)),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Placeholder")), _.eLit("The initial Placeholder")),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Prompt")), _.eLit("The initial Prompt")),
                        _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Title")), _.eLit("The initial Title")),
                        _.eCall(_._("ctl", idents.fldDispObjBag, idents.methodBagPublish)),
                        _.eCall(_._("ctl", "OnDidChangeValue"), _.eFunc([{ Name: "input", Type: TypeRefPrim.String }], null,
                            _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Prompt")), _.eLit("Lower: {0}", _.eCall(_._("strLo"), _._("ctl", idents.fldDispObjBag, this.fld("Value"))))),
                            _.iSet(_._("ctl", idents.fldDispObjBag, this.fld("Title")), _.eLit("Upper: {0}", _.eCall(_._("strUp"), _._("ctl", idents.fldDispObjBag, this.fld("Value"))))),
                            _.eCall(_._("ctl", idents.fldDispObjBag, idents.methodBagPublish)),
                        )),
                        _.iVar("finalinputvalue", { Maybe: TypeRefPrim.String }),
                        _.eCall(_._("ctl", "OnDidAccept"), _.eFunc([], null,
                            _.iSet(_._("finalinputvalue"), _.oAddr(_._("ctl", idents.fldDispObjBag, this.fld("Value")))),
                            _.eCall(_._("ctl", "Hide")),
                        )),
                        _.eCall(_._("ctl", "OnDidHide"), _.eFunc([], null,
                            _.eCall(_._("ctl", "Dispose")),
                            _.iIf(_.oIs(_._("finalinputvalue")), [
            ...
            "demo_Window_CreateTerminal": () =>
                this.genInput(
                    ...
                    _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("CreateTerminal", 2)), _._("cfg")),
                        _.eFunc([{ Name: "term", Type: { Maybe: { Name: "Terminal" } } }], null,
        ...
        this.all["demosMenu"] = () => ([
            ...
            ...this.genMenu(_, _.eLit("This menu can be re-opened any time via our custom status-bar item."),
                _.eFunc([{ Name: "menuitems", Type: { ValsOf: { Name: "QuickPickItem" } } }], null,
                    _.iIf(_.oIs(_._("menuitems")),
                        allnames.map((name: string): Instr =>
                            _.iIf(_.oEq(_.eLit(name), _._(_.oIdx(_._("menuitems"), _.eLit(0)), _._(this.fld("Label")))), [
        ...
        this.all["onUpAndRunning"] = () => ([
            _.iBlock(
                _.eCall(_._("subscribeToMiscEvents")),
            ),
            ...
            _.iBlock(
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateOutputChannel"),
                    _._("appName")), _.eFunc([{ Name: "it", Type: { Maybe: { Name: "OutputChannel" } } }], null,
                        _.iSet(_._("logchan"), _._("it")),
                        _.eCall(_._("setOutChan"), _._("logchan")),
                        _.eCall(_._("logLn"), _.eCall(_._("strFmt"), _.eLit("Hi, I'm `{0}`, this is my own custom `OutputChannel` where I leisurely log all your interactions with me. When I'm ended, it too will disappear."), _._("appName"))),
            ...
            _.iBlock(
                ...
                _.iSet(_._("clickcount"), _.eLit(0)),
                _.iVar("mycmd", { From: [{ ValsOf: TypeRefPrim.Any }], To: TypeRefPrim.Any }),
                _.iSet(_._("mycmd"), _.eFunc([{ Name: "_unused", Type: { ValsOf: TypeRefPrim.Any } }], TypeRefPrim.Any,
                    _.iSet(_._("clickcount"), _.eOp("+", _.eLit(1), _._("clickcount"))),
                    _.eCall(_.eCall(_._("statusitem", idents.fldDispObjBag, idents.methodBagFetch)), _.eFunc([], null,
                        _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Text")), _.eCall(_._("logLn"), _.eLit("You clicked me {0} time(s).", _._("clickcount")))),
                        _.iIf(_.oEq(_.eLit("editorLightBulb.foreground"), _._("statusitem", idents.fldDispObjBag, this.fld("Color"))), [
                            _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Color")), _.eLit("terminal.ansiGreen")),
                            _.iIf(_.oAnd(_._("toggleonclick"), _.oIs(_._("logchan"))), [_.eCall(_._("logchan", "Hide"))]),
                        ], [
                            _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Color")), _.eLit("editorLightBulb.foreground")),
                            _.iIf(_.oAnd(_._("toggleonclick"), _.oIs(_._("logchan"))), [_.eCall(_._("logchan", "Show"), _.eLit(true))]),
                        ]),
                        _.eCall(_.eCall(_._("statusitem", idents.fldDispObjBag, idents.methodBagPublish)), _._("demosMenu")),
                    )),
                    _.iRet(_.eZilch()),
                )),
                ...
                _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), "CreateStatusBarItem"),
                    ...
                    _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Tooltip")), _.eLit("Hi from {0}!", _._("appName"))),
                    _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Text")), _.eLit("You clicked me 0 time(s).")),
                    _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Color")), _.eLit("#42BEEF")),
                    _.iSet(_._("statusitem", idents.fldDispObjBag, this.fld("Command")), _._("cmdName")),
                    _.eCall(_._("statusitem", idents.fldDispObjBag, idents.methodBagPublish)),
    ...
    genDemoOfDialog(_: Builder, which: string, mult: boolean, label: string): Instr[] {
        ...
        return [
            ...
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), `Show${which}Dialog`), _._("opts")),
                _.eFunc([{ Name: fp, Type: mult ? { ValsOf: TypeRefPrim.String } : { Maybe: TypeRefPrim.String } }], null,
                    _.iIf(_.oIsnt(_._(fp)), [
        ...
        return [
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", ns)), "AllProperties")),
                _.eFunc([{ Name: "props", Type: { Name: struct.Name } }], null,
                    _.iVar("items", { ValsOf: TypeRefPrim.String }),
                    _.iSet(_._("items"), _.eCollNew(_.eLit(struct.Fields.length), TypeRefPrim.String, true)),
                    _.iBlock(..._.EACH(struct.Fields, (f, i): Instr[] => [
                        ...
                        ...this.genMenu(_, _.eOp("+", _.eCall(_._("logLn"), _.eLit(ns + " has {0} properties", _.eLen(_._("items"), true))), _.eLit(":")))
                    )),
                ),
            ),
        ]
    ...
    genDemoOfStrListMenu(_: Builder, ns: string, fn: string, desc: string, args: Expr[], onPick?: Expr): Instr[] {
        return [
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", ns)), fn),
                ...
                ...this.genMenu(_, _.eLit("Retrieved {0} " + desc, _.eLen(_._("items"), true)), onPick),
            ))
        ]
    }
    ...
    genMenu(_: Builder, msg: Expr, onPick?: Expr): Instr[] {
        return [
            ...
            _.eCall(_.eCall(_._(_.eProp(_._("vsc", "Window")), this.fn("ShowQuickPick", 2)),
                _.eCall(_._("quickPickItemsFrom"), _._("items")), _._("opts"), _.eZilch()
            ), onPick ? onPick : _.eFunc([{ Name: "menuitems", Type: { ValsOf: { Name: "QuickPickItem" } } }], null,
                _.iIf(_.oIs(_._("menuitems")), [
    ...
    fn(name: string, _overload: number): string {
