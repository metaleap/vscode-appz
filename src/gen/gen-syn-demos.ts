        ...
        this.all = {
            ...
            "demo_Window_CreateInputBox": () => [
                _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateInputBox"))),
                    _.eFunc([{ Name: "inputbox", Type: { Maybe: { Name: "InputBox" } } }], null,
                        _.eCall(_.eCall(_.oDot(_.n("inputbox"), _.n("Get"))), _.eFunc([{ Name: "props", Type: { Name: "InputBoxState" } }], null,
                            ...
                            _.eCall(_.eCall(_.oDot(_.n("inputbox"), _.n("Set")), _.n("props")), _.eFunc([], null,
                                _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidChangeValue")), _.eFunc([{ Name: "input", Type: TypeRefPrim.String }], null,
                                    _.eCall(_.eCall(_.oDot(_.n("inputbox"), _.n("Get"))), _.eFunc([{ Name: "p", Type: { Name: "InputBoxState" } }], null,
                                        _.iSet(_.oDot(_.n("p"), _.n(this.fld("Prompt"))), _.eLit("Lower: {0}", _.eCall(_.n("strLo"), _.oDot(_.n("p"), _.n(this.fld("Value")))))),
                                        _.iSet(_.oDot(_.n("p"), _.n(this.fld("Title"))), _.eLit("Upper: {0}", _.eCall(_.n("strUp"), _.oDot(_.n("p"), _.n(this.fld("Value")))))),
                                        _.eCall(_.oDot(_.n("inputbox"), _.n("Set")), _.n("p")),
                                    )),
                                )),
                                _.iVar("finalinputvalue", { Maybe: TypeRefPrim.String }),
                                _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidAccept")), _.eFunc([], null,
                                    _.eCall(_.eCall(_.oDot(_.n("inputbox"), _.n("Get"))), _.eFunc([{ Name: "p", Type: { Name: "InputBoxState" } }], null,
                                        _.iSet(_.n("finalinputvalue"), _.oAddr(_.oDot(_.n("p"), _.n(this.fld("Value"))))),
                                        _.eCall(_.oDot(_.n("inputbox"), _.n("Hide"))),
                                    )),
                                )),
                                _.eCall(_.oDot(_.n("inputbox"), _.n("OnDidHide")), _.eFunc([], null,
                ...
                _.eCall(
                    ...
                    _.eFunc([{ Name: "_commandRegisteredAtThisPoint", Type: { Maybe: { Name: "Disposable" } } }], null,
                        _.eCall(_.eCall(_.oDot(_.eProp(_.oDot(_.n("vsc"), _.n("Window"))), _.n("CreateStatusBarItem")),
                            ...
                            _.iVar("props", { Name: "StatusBarItemState" }),
                            _.iSet(_.n("props"), _.eNew({ Name: "StatusBarItemState" })),
